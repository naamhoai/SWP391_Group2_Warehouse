...
<head>
    ...
    <style>
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 10px 15px -3px rgba(59, 0, 246, 0.3), 0 4px 6px -2px rgba(59, 0, 246, 0.1);
        }
        ...
        .search-input:focus {
            box-shadow: 0 0 0 3px rgba(59, 130, 6, 0.3);
        }
...
<body class="bg-gray-50 min-h-screen font-sans antialiased">
    ...
    <aside id="sidebar" class="sidebar w-72 text-white p-6 fixed h-full z-50">
        <div class="sidebar-header flex items-center mb-8">
        ...
        <div class="mb-6 px-2">
            <div class="relative">
                <input type="text" placeholder="Tìm kiếm..." 
                       class="w-full p-2 bg-white bg-opacity-20 text-white placeholder-white placeholder-opacity-70 rounded-lg py-3 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 search-input">
