                        ...
                        <c:if test="${request != null}">
                                ...
                                <div class="info-section">
                                    ...
                                    <div class="info-grid-2col">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <span
                                                class="status-badge status-${request.requestStatus}">${request.requestStatus}</span>
                                        </div>
                                        <div class="info-item">
                                            ...
                                            <tbody>
                                                <c:forEach var="d" items="${details}" varStatus="status">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="condition-badge condition-${d.materialCondition}">
                                                                ${d.materialCondition}
                                                            </span>
                                                        </td>
                                                    </tr>
                                ...
                                <div class="details-section">
                                    ...
                                    <form action="approveOrRejectRequest" method="post" class="approve-reject-form">
                                        ...
                                        <div class="form-group">
                                            <label for="directorNote" class="form-label"><b>Lý do (bắt
                                                    buộc):</b></label>
                                            <textarea name="directorNote" id="directorNote" required
                                                class="input-reason"
                            ...
                            <c:if test="${request.requestStatus eq 'Đã duyệt' && sessionScope.roleId == 3}">
                                <div class="details-section">
                                    <h3>Hành động</h3>
                                    <div class="action-btn-group">
                                        <a href="createExportForm?requestId=${request.requestId}"
