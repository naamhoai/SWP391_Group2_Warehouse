...
public class SidebarMenuDAO {
    ...
    public List<SidebarMenu> getSidebarMenuByUser(int userId, int roleId) throws SQLException {
        ...
        while (rs.next()) {
            ...
            menu.setParentId(rs.getObject("parent_id") != null ? rs.getInt("parent_id") : null);
            menu.setPermissionId(rs.getObject("permission_id") != null ? rs.getInt("permission_id") : null);
            menuList.add(menu);
        }
        return menuList;
    }
